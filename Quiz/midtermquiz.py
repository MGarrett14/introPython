...
'A computer program is a set of instructions on how to program things like a video game or a bank app.'
...
'Complexity is a measurment of the amount of resources a program can taken in.'
'Abstraction is the process of taking complex materials and simplifiying them for coding.'

'An example of complexity is designs of a video game character'
'A way to abstract designs of a video game character is by drawing out and sketiching ideas for the design before the actual design is put in'


# 3. What is Syntax in Python and why is it important to write proper syntax?
'Syntax in python is the way of how you type a code'
'Syntax is important, because if you dont use proper syntax than the code wont run properly.'

# 4. What is a function, and why do we wrap our code inside of functions?
'A function is a way of abstracting pieces of code by wrapping/packing the code'
'We wrap our code inside a function so we can reuse the code and the code can be used for better modularity'

# 5. Name and describe the three (3) naming conventions for variables in python? Then provide three (3) name rules for Python
# variables. 
'The three naming conventions for variables is camel case, which each word except the first one can be capitalized,pascal case where each word starts with a capital letter, and snake case where each word is separated by a underscore character.'
'Three naming rules for variables is that a variable name cannot start with a number, a variable name cann be any python keywords, and a variable name must sart with a lettero r underscore character'
...
print(name)
print(student)
'The output of the print functions when this code is ran is the name of the students.'
'Those would be printed out, because the variables name and student was wrapped in the print function and the values in those variables is names of students'

# 7. Describe the difference between each of the following assignment operators:
# = This operator means that something is equal to a value
# == This operator also shows that something is equal to value
# != This operator means that something is not equal to a value
 
# 8. What type of data can be stored in a python list?
'The type of data that can be stored into a python list is a string data type'
...
# 'The difference between a function argument and a function paramete is that an argument you need to bring in actual facts/data'
# 'But with a parameter it can placehold any data wether if its true or not'
...
# 'If you run into a type error in your terminal that means you have 
...
# 'If you run into this issues, it usually means that you indent  something wrong in your code, and to fix it you hae to fix and indent it correctly'
...
# ' The item at index five is gift card
